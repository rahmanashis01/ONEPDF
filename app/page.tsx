...
export default function LandingPage() {
  return (
    <main>
        ...
        <div className="mx-auto flex max-w-4xl flex-col gap-10 px-4 py-20 sm:py-28">
          <Reveal className="flex flex-col gap-6">
            ...
            <div className="flex flex-wrap items-center gap-3">
              <Link
                href="/merge"
                className="gradient-brand inline-flex items-center gap-2 rounded-full px-6 py-3 text-sm font-medium text-white shadow-md shadow-fuchsia-500/20 transition-all hover:-translate-y-0.5 hover:brightness-110"
              >
                Merge a PDF <ArrowRight className="size-4" />
              </Link>
              <Link
                href="/compress"
                className="gradient-brand-violet inline-flex items-center gap-2 rounded-full px-6 py-3 text-sm font-medium text-white shadow-md shadow-violet-500/20 transition-all hover:-translate-y-0.5 hover:brightness-110"
              >
              ...
              <a
                ...
                title="github"
                className="inline-flex items-center gap-2 rounded-full border bg-white/70 px-4 py-2.5 text-sm font-medium text-foreground/80 backdrop-blur transition-colors hover:bg-white"
              >
        ...
        <div className="mx-auto max-w-4xl px-4 pb-16 pt-16">
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
            <Reveal delay={0.05}>
              ...
              >
                <Card className="card-glow-pink relative h-full border-border/60 bg-white/80 shadow-sm backdrop-blur transition-all duration-300 hover:-translate-y-1 hover:shadow-xl">
                  <CardHeader>
                    <div className="mb-3 flex size-11 items-center justify-center rounded-xl bg-fuchsia-500/10 text-fuchsia-600 transition-transform duration-300 group-hover:scale-110">
                  ...
                  <CardContent>
                    <span className="inline-flex items-center gap-1 text-sm font-medium text-fuchsia-600 transition-transform duration-300 group-hover:translate-x-0.5">
            ...
            <Reveal delay={0.12}>
              <Link
                ...
                className="group block rounded-2xl outline-none focus-visible:ring-2 focus-visible:ring-ring/50"
              >
                <Card className="card-glow-violet relative h-full border-border/60 bg-white/80 shadow-sm backdrop-blur transition-all duration-300 hover:-translate-y-1 hover:shadow-xl">
                  <CardHeader>
                    <div className="mb-3 flex size-11 items-center justify-center rounded-xl bg-violet-500/10 text-violet-600 transition-transform duration-300 group-hover:scale-110">
                  ...
                  <CardContent>
                    <span className="inline-flex items-center gap-1 text-sm font-medium text-violet-600 transition-transform duration-300 group-hover:translate-x-0.5">
      ...
      {/* UPCOMING */}
      <section id="upcoming" className="mx-auto max-w-4xl px-4 py-16">
        <Reveal className="mb-8 flex flex-col gap-2">
          <Badge variant="secondary" className="w-fit rounded-full">
            ...
            return (
              <Reveal key={item.title} delay={index * 0.06}>
                <div className="group h-full">
                  <Card
                    className={`${item.glow} relative h-full border-border/60 bg-white/80 shadow-sm backdrop-blur transition-all duration-300 hover:-translate-y-1 hover:shadow-xl`}
                  >
                    <CardHeader>
                      <div
